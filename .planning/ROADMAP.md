...
- [x] 02-05-PLAN.md -- Schedules and fares: RecurringScheduleScreen, auto-post logic, FareHistoryScreen, balance tracking
**UI hint**: yes
...
- [x] 03-04-PLAN.md -- Cloud Functions: server-side FCM triggers for chat messages and ride match notifications
**UI hint**: yes
