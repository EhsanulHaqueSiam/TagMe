...
- [Phase 05]: Used ScaleTransition for marker pulse (hardware-accelerated, clean with AnimationController)
- [Phase 05]: sendStopToFirestore flag on _stopLiveSharing to avoid Firestore write during dispose
