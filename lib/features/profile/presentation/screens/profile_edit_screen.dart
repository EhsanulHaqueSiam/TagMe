...
/// Screen for editing an existing student profile.
///
/// Same layout as ProfileSetupScreen with pre-populated fields,
/// "Edit Profile" title, and "Update Profile" button.
...
class _ProfileEditScreenState extends ConsumerState<ProfileEditScreen> {
  ...
  void _initFromProfile(Student profile) {
  ...
  Future<void> _updateProfile() async {
    ...
    final student = Student(
      ...
      gender: _gender!,
      photoUrl: _photoFile?.path ?? _existingPhotoUrl,
    );
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                    child: AvatarPicker(
                      currentPhotoPath:
                          _photoFile?.path ?? _existingPhotoUrl,
                      onPhotoPicked: (file) {
